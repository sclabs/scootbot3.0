...
def test_import():
    ...
    assert scootbot3 is not None

    del scootbot3
    sys.modules.pop("scootbot3")
...
def test_get_version_with_setuptools_scm(version_regex):
    ...
    assert version_regex.match(scootbot3.__version__)
...
def test_get_version_without_install(
    ...
    """
    hide_packages_from_import("setuptools_scm")
    hide_packages_from_importlib("scootbot3")

    with pytest.warns(UserWarning):
        import scootbot3

        assert scootbot3.__version__ == "unknown"
